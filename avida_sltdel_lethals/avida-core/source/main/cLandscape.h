...
public:
  ...
  inline double GetProbSltNeg() const { return static_cast<double>(slt_neg_count) / total_count;}
  inline double GetProbAllNeg() const { return static_cast<double>(slt_neg_count + neg_count) / total_count;}
  ...
  inline double GetAvNegSize() const { if (neg_count == 0) return 0; else return neg_size / (neg_count + slt_neg_count); }
  inline double GetAvgNegLethalSize() const { if (neg_count == 0) return 0; else return neg_size / (neg_count + dead_count + slt_neg_count); }
